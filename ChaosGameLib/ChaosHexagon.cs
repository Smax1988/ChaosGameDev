...
{
    /// <summary>
    /// Creates the fractal based on a hexagon as a MemoryStream
    /// </summary>
    ...
    public static MemoryStream CreateHexagonMemoryStream(int iterations, int imgWidth, int imgHeight, Color color)
    {
