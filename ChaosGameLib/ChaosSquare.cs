...
/// <summary>
/// Class provides functionality to create a square fractal.
/// </summary>
public class ChaosSquare : ChaosBase
{
    /// <summary>
    /// Creates the fractal based on a square as a MemoryStream
    /// </summary>
    ...
    public static MemoryStream CreateSquareMemoryStream(int iterations, int imgWidth, int imgHeight, Color color)
    {
